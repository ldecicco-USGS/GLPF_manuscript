...
Models reported in the current study for describing bacteria variability using optical signals were developed using data sets that represented three groups of sites and one individual site. Each data set represented a specific type of watershed setting with potential for distinctly different background DOC that could impact the relation between optical signals and bacteria abundance: Large watersheds dominated by agricultural influence, large watersheds dominated by urban influence, a mixed land use watershed with seiche effect from Lake Michigan, and subwatersheds dominated by urban influence. The agricultural watersheds are located in the Western Lake Erie drainage basin and all have > xx% agricultural influence with similar geologic and soil conditions (**<span custom-style="OrangeText">add reference here</span>**). The urban watersheds, located in the Detroit metropolitan area, both have active combined sewer overflows at times, and have similar geologic and soil conditions (**<span custom-style="OrangeText">add reference here</span>**). The Milwaukee River includes a mix of urban and agricultural land use, is influenced by frequent flow reversals and mixing of Milwaukee Harbor and Lake Michigan with water from the Milwaukee River watershed resulting in a unique combinations of DOC sources. The subwatershed sites are all within the Menomonee River watershed in the Milwaukee metropolitan area dominated by residential, commercial, and industrial urban land cover. The upper portion of the Menomonee River includes some agricultural influence to a lesser extent. 

Sampling sites within the small watersheds included storm sewers, ditches, and small streams in urban areas. These sites drain small areas, and therefore, have relatively small flows that can be greatly influenced by contamination from individual discharges (e.g misconnections or leaks from single sources). Depending on the nature of the individual source and timing of the discharge in relation to sample collection times, DOC (and therefore optical signals) and human-associated bacteria can vary widely. Wastewater contamination from these individual sites can include sources such as laundry, bathing, industrial waste, and human waste among others. In addition, other non-human sources can influence the optical signals in an unpredictable manner such as, wildlife waste, pet waste, and leaf leachate. This is likely to be the primary reason that modeling attempts were unsuccessful for small-scale sites. In contrast, flow contributing to the watershed and subwatershed sites represents a composite from many diverse sources in the watershed, resulting in a flow-weighted average of the sewage, bacteria, and DOC signal with less dynamic influence from individual sources than the small-scale sites. 


can dampen the fluctuations in DOC and human-associated bacteria signals that is present at the small scale sites. This difference in variability is a potential reason that development of models for small scale sites was not possible while reasonable models were achievable for the watershed and subwatershed scale sites. 

Large scale differences in background DOC can 

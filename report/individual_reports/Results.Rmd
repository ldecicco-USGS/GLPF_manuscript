...
Sampling sites within the small watersheds included storm sewers, ditches, and small streams in urban areas. These sites drained small areas, and therefore, have relatively small flows that can be greatly influenced by contamination from individual discharges (e.g misconnections or leaks from single sources). Depending on the nature of the individual source and timing of the discharge in relation to sample collection times, DOC (and therefore optical signals) and human-associated bacteria can vary widely. Wastewater contamination from these individual sites can include sources such as laundry, bathing, industrial waste that do not necessarily contain human waste, but will have influence on optical signals, and some sources contain human waste that will have great influence on human bacteria as well as optical signals. An illustration of this variability can be observed in the comparison sampling results from local sanitary sewer samples and the influent to sewage treatment plants. As a measure of relative variability, the coefficient of variation (standard deviation/ mean) for bacteria results and optical properties of water were computed and compared between the two sources. 
## Add in more info on comparison of sources.
...
**<span custom-style="OrangeText">Need to add some info into this discussion about small-scale sanitary sewer variability for HIB and DOC.e</span>**

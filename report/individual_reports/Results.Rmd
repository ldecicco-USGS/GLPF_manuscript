...
Large watershed sites were grouped into Agricultural (Maumee, Portage, and Raisin), Urban (Clinton and Rouge), and a single site (Milwaukee) for model development. 
...
names(model_summary) <- make.names(names(model_summary))
 ...
 Header1 <- c("", "", "Human Bacteroides", "Human Bacteroides", "Lachnospiraceae", "Lachnospiraceae", "Enterococci","Enterococci", "Enterococci Culture", "Enterococci Culture", "E. coli", "E. coli")

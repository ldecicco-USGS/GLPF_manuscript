...
Final variables selected in models could help govern how to design field-level monitoring systems for estimating wastewater contamination. The sensor models indicated that this could potentially be done with currently available sensors with T and F fluorescence signals. These models, however, were developed using data from laboratory analysis. Additional work will be needed to understand the steps necessary to translate these models to a field setting. Analysis of how the field sensors respond in comparison to the corresponding signals measured by the laboratory instrument will be needed as well as adjustments for the influence of turbidity,temperature, and inner filter effects on field sensor results (Saraceno et al., 2017; Downing et al., 2015; Watras et al., 2014). 
...
**Seasonality**
 ...
 Inclusion of seasonal variables in the large watershed and subwatershed regressions suggest a seasonal influence
